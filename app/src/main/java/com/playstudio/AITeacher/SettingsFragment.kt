...
class SettingsFragment : PreferenceFragmentCompat() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<Preference>("theme_selection")?.setOnPreferenceClickListener {
            showThemeSelectionDialog()
            true
        }
        
        // Initialize theme preference summary
        val themeManager = ThemeManager(requireContext())
        findPreference<Preference>("theme_selection")?.summary = themeManager.getCurrentTheme().themeName
    }
    ...
    private fun showThemeSelectionDialog() {
        ...
        val dialog = ThemeSelectionDialog(requireContext(), currentTheme) { selectedTheme ->
            themeManager.setTheme(selectedTheme)
            
            // Update the preference summary
            findPreference<Preference>("theme_selection")?.summary = selectedTheme.themeName
