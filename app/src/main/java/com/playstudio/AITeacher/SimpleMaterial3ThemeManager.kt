...
class SimpleMaterial3ThemeManager(private val context: Context) {
    ...
    fun getThemeResources(): SimpleThemeResources {
        return if (isDarkMode()) {
            SimpleThemeResources.Dark
        } else {
            SimpleThemeResources.Light
        }
    }
}

sealed class SimpleThemeResources {
    ...
    object Light : SimpleThemeResources() {
    ...
    object Dark : SimpleThemeResources() {
