    ...
    private fun showChatGptOptionsDialog() {
        ...
        listView.setOnItemClickListener { _, _, position, _ ->
            if (isUserSubscribed && subscriptionExpirationTime > System.currentTimeMillis() || canSendMessage) { // Added canSendMessage check
                ...
                // Enable our custom web search for the search preview models
                isWebSearchEnabled = selectedModelIdentifier in listOf("gpt-4o-search-preview", "gpt-4o-mini-search-preview")
                currentModel = when (selectedModelIdentifier) {
                    "gpt-4o-search-preview" -> "gpt-4o"
                    "gpt-4o-mini-search-preview" -> "gpt-4o-mini"
                    else -> selectedModelIdentifier
                }
