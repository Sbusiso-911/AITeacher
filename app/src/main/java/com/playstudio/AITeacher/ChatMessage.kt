...
data class ChatMessage(
    ...
    constructor(parcel: Parcel) : this(
        ...
        parcel.readByte() != 0.toByte(), // isWebSearchResult
        parcel.readString() // structuredContentJson
    )
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int) {
        ...
        parcel.writeByte(if (isWebSearchResult) 1 else 0)
        parcel.writeString(structuredContentJson)
    }
    ...
    fun storeStructuredContent(educationalResponse: com.playstudio.aiteacher.models.EducationalResponse) {
        ...
        try {
            this.structuredContentJson = com.google.gson.Gson().toJson(educationalResponse)
        } catch (e: Exception) {
            android.util.Log.e("ChatMessage", "Failed to serialize structured content", e)
        }
    }

    fun loadStructuredContent(): com.playstudio.aiteacher.models.EducationalResponse? {
